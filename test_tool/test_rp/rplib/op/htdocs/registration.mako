...
<%block name="body">
  ...
  <p>If the RP does not support dynamic client registration please generate
    static client credentials in order to
    ...
    <div class="col-sm-3">
      ...
      <form>
        <div class="input-group">
          <input type="text" ng-model="new_redirect_uri.value"
                 class="form-control">
