...
def render_body(context, **pageargs):
    ...
    try:
        ...
        __M_writer(
            '<!DOCTYPE html>\n\n<html>\n<head>\n    <title>OpenID '
            'Certification RP Test</title>\n    <meta name="viewport" '
            'content="width=device-width, initial-scale=1.0">\n    <link '
            'href="static/opresultqr.css" rel="stylesheet" '
            'media="screen">\n\n    <!-- Bootstrap -->\n    <link '
            ...
            '  <div class="jumbotron">\n        <form class="repost" '
            'action="authz_post" method="post">\n            <input '
            'type="hidden" name="fragment" id="frag" value="x"/>\n            '
            '<script type="text/javascript">\n                if('
            'window.location.hash) {\n                    var hash = '
            'window.location.hash.substring(1); //Puts hash in variable, '
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "line_map": {"26": 20, "20": 1, "15": 0},
"uri": "opresult_repost.mako", "filename": "htdocs/opresult_repost.mako"}
__M_END_METADATA
"""
