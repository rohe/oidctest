...
def render_body(context, **pageargs):
    ...
    try:
        ...
        __M_writer(
            ...
            'action -->\n      <div class="jumbotron">\n        '
            '<h1>RPTEST</h1>\n          <h3>Chose the next test flow you want '
            'to run from this list: </h3>\n            ')
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "line_map": {"38": 0, "46": 22, "47": 46,
"48": 46, "54": 48, "15": 1}, "uri": "flowlist.mako", "filename":
"htdocs/flowlist.mako"}
__M_END_METADATA
"""
