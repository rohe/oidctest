...
<%block name="body">
    ...
    <div class="header">
        ...
        <div>
            ...
            <div>
                <button type="button" class="btn btn-primary" ng-click="init_login(login_url)">Login</button>
            </div>
        </div>
    </div>
...
<%block name="footer">
    ...
    <script type="text/javascript" src="/static/rp_3rd_party_init_login.js"></script>
